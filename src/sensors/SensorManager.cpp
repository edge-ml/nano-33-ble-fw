...
void SensorManager::end_sensor(int ID) {
    // End sensor
    int pos = sensor_module_pos[ID];
    int module = module_assignment[ID];
...
void SensorManager::init_act_map(ModuleActive& act, const int *MAP) {
...
void SensorManager::init_assignment(const int ID, int MODULE) {
...
void SensorManager::activate_pos(int module, int pos) {
    ModuleActive act;
    act = active[module];
    act.active[pos] = true;
}

void SensorManager::deactivate_pos(int module, int pos) {
    ModuleActive act;
    act = active[module];
    act.active[pos] = false;
}

bool SensorManager::all_inactive(int module, int pos) {
